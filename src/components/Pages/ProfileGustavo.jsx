...
export default function ProfileGustavo() {
  ...
  // Ahora cada habilidad tiene un nivel de 0-100
  const skills = [
    { name: 'Node.js', description: 'Desarrollo de APIs escalables', level: 95 },
    { name: 'Python', description: 'Data science y automatización', level: 88 },
    { name: 'MongoDB', description: 'Base de datos NoSQL', level: 90 },
    { name: 'PostgreSQL', description: 'Base de datos relacionales', level: 85 },
    { name: 'Docker', description: 'Containerización y DevOps', level: 82 },
    { name: 'AWS', description: 'Cloud computing y microservicios', level: 78 },
  ]
    ...
    <section className="profile-page">
      <div className="profile-header">
        ...
        <div className="social-links">
          <a href="https://github.com/gustavo-dev" target="_blank" rel="noopener noreferrer" className="social-btn github" title="GitHub">
          ...
          <a href="https://linkedin.com/in/gustavo-backend" target="_blank" rel="noopener noreferrer" className="social-btn linkedin" title="LinkedIn">
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
          ...
          <a href="mailto:gustavo@digitalcreators.com" className="social-btn email" title="Email">
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
